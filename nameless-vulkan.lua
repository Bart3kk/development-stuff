...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(12, 4, 20)), ColorSequenceKeypoint.new(0.38, Color3.fromRGB(4, 4, 4)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(4, 4, 4)), ColorSequenceKeypoint.new(0.68, Color3.fromRGB(4, 4, 4)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(12, 4, 20))}
UIGradient.Parent = FakeChatUI

System.MouseButton1Click:Connect(function()
...
Roblox.MouseButton1Click:Connect(function()
    ...
    builderman.MouseButton1Click:Connect(function()
        PlayerBox.Text = "[builderman]"
        end)

        mrflimflam.MouseButton1Click:Connect(function()
            ...
            Hunt.MouseButton1Click:Connect(function()
                ...
                Shutdown.MouseButton1Click:Connect(function()
                    ...
                    TeamJoin.MouseButton1Click:Connect(function()
                        MessageBox.Text = "You are now on the 'Admin' team"
                        PlayerBox.Text = "{Team}"
                        end)

                        FriendJoined.MouseButton1Click:Connect(function()
                            MessageBox.Text = "Your friend Name has joined the experience"
                            PlayerBox.Text = "{System}"
                            end)    

                            ChatButton.MouseButton1Click:Connect(function()
    local A_1 = NameBox.Text.."                                                                                                                             "..""..PlayerBox.Text..": ".. MessageBox.Text
                                local A_2 = "All"
								if game:GetService("TextChatService"):FindFirstChild("TextChannels") then
									game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync(A_1)
									else
